...
public class BASE64Utils {
	...
	private static byte[] decode_buffer = new byte[4];
	...
	private static void decodeBuffer(InputStream paramInputStream, OutputStream paramOutputStream) throws IOException {
	...
	private static void decodeAtom(PushbackInputStream paramPushbackInputStream, OutputStream paramOutputStream, int paramInt)
			throws IOException {
		int i;
		int j = -1;
		int k = -1;
